...
function SecondPage() {
  ...
  const html = `
    ...
    <p>
      After graduation I plan to pursue a PhD in Chemistry focusing on theoretical chemistry, and build a
      career in research. I am incredibly passionate about chemistry, research, and contributing ethically to
